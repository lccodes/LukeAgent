 ...
 * 
 * Then, create a **YourName**Agent class that extends BrownAgent
...
public abstract class BrownAgent extends SampleAdNetworkProtected{
	...
	public BrownAgent() {
		super();
		System.out.println("Brown Agent");
